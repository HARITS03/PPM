                    ...
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Selamat Datang di <br> Pelaporan Pengaduan Masyarakat!</h1>
                                <hr>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <a class="small" href="<?= base_url('reg') ?>">Create an Account!</a>
                                <br>
                                <a class="small" href="<?= base_url('adminsetup') ?>">Login Admin!</a>
                            </div>
                        </div>
                    </div>
                </div>
