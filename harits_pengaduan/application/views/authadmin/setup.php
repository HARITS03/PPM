...
<body>
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg col-xl-7" style="margin: auto;margin-top:150px;">
            <div class="card-body p-0 ">
                <div class="p-5 ">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Setup Aplikasi <br> Pengaduan Pelaporan Masyarakat! </h1>
                        <hr>
                    </div>
                    <form class="user" action="<?= base_url('adminsetup2') ?>" method="post">
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            <input type="number" class="form-control form-control-user" id="telp" name="telp" placeholder="Telepon">
                        </div>
                        <div class="mt-3 mb-3">
